...
int main()
{
    ...
    printf("Pagefaults: %d", pageFaults);
...
// void printOuterStructure(int m)
// {
//     printf("Stream ");
...
// void printCurrFrames(int item, int frame_items[], int frame_occupied, int m)
// {
...
// void optimalPage(int ref_str[], int refStrLen, int frame_items[], int m)
// {
//     // initially none of the frames are occupied
//     int frame_occupied = 0;
//     printOuterStructure(m);
...
//         {
//             hits++;
//             printCurrFrames(ref_str[i], frame_items, frame_occupied, m);
//             continue;
//         }
...
//     }
//     printf("\n\nHits: %d\n", hits);
//     printf("Faults: %d", refStrLen - hits);
// }
